...
{	
	...
	public class LoadingSceneManager : MonoBehaviour 
	{
		...
		protected virtual IEnumerator LoadAsynchronously() 
		{
			...
			// we fade to black
			MMFadeInEvent.Trigger(ExitFadeDuration, MMTween.MMTweenCurve.EaseInCubic, 0, true);
		...
		{
			MMFadeOutEvent.Trigger(StartFadeDuration, MMTween.MMTweenCurve.EaseInCubic, 0, true);
