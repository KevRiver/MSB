...
namespace MoreMountains.Tools
{
    ...
    public class ShaderController : MonoBehaviour
    {
        ...
        public enum PropertyTypes { Bool, Float, Int, Vector, Keyword }
        ...
        [EnumCondition("ControlMode", (int)ControlModes.PingPong)]
        [Header("Ping Pong")]
        ...
        [Vector("Min", "Max")]
        /// the noise amplitude
        [EnumCondition("ControlMode", (int)ControlModes.Random)]
        ...
        [EnumCondition("ControlMode", (int)ControlModes.OneTime)]
        ...
        [EnumCondition("ControlMode", (int)ControlModes.AudioAnalyzer)]
        ...
        protected virtual void Update()
        {
            ...
            switch (ControlMode)
            {
                case ControlModes.PingPong:
                    PingPong = Mathf.PingPong(GetTime(), Duration);
