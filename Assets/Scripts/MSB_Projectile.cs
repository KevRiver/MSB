...
public class MSB_Projectile : MMPoolableObject
{
    [Header("Movement")]
	    ...
	    protected virtual void Awake ()
		{
			...
			_damageOnTouch = GetComponent<MSB_DamageOnTouch>();
		...
		{
			_owner = newOwner;
			MSB_DamageOnTouch damageOnTouch = this.gameObject.MMGetComponentNoAlloc<MSB_DamageOnTouch>();            
