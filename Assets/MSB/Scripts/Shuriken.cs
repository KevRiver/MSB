...
public class Shuriken : MMPoolableObject
{
    [Header("Movement")]
    ...
    private MSB_Character ownerMSBCharacter;
    ...
    {
        _owner = newOwner;
        if (_owner.GetComponent<MSB_Character>() == null)
        {
            Debug.LogWarning("Shuriken : No MSB Character");
            return;
        }
        ownerMSBCharacter = _owner.GetComponent<MSB_Character>();
        ...
        if (damageOnTouch != null)
        {
            ...
            damageOnTouch.Owner = newOwner;
            damageOnTouch.isBelongToLocalUser = ownerMSBCharacter.isLocalUser;
